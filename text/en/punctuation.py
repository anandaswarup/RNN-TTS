"""Pipeline to handle punctuations in English text"""
...
class Punctuation:
    """Pipeline for handling punctuations in text
    """

    def __init__(self, puncs=_DEF_PUNCS):
    ...
    def _strip_to_restore(self, text):
        ...
        # convert str text to a list of strs, each item is separated by a punctuation
        splitted_text = []
